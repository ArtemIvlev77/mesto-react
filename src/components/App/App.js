      ...
      <div className="App">
        <div className="page">
          <div className="page__container">
            ...
            <Main/>
            <Footer/>
            <PopupWithForm type="profileEditor" title="Редактировать профиль">
            ...
            <PopupWithForm type="newElement" title="Новое место"/>
            <PopupWithForm type="popupSubmit" title="Вы уверены?"/>
            <PopupWithForm type="popupEditAvatar" title="Обновить аватар"/>
          </div>

          <div className="popup popup_type_newElement">
          ...
          <div className="popup popup_type_elementPreview">
          ...
          <div className="popup popup_type_popupSubmit">
            <div className="popup__container">
          ...
          <div className="popup popup_type_popupEditAvatar">
            <div className="popup__container">
          ...
          <template className="template">
            <li className="element">
              <button type="button" className="element__image-btn"><img src=" " alt=" " className="element__image"/>
              </button>
