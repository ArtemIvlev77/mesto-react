...
function Main() {
  ...
  function handleEditProfileClick() {
    document.querySelector('.popup_type_profileEditor').classList.add('popup_is-opened');
  }
        ...
        <section className="profile page__section">
          ...
          <div className="profile__info">
            <div className="profile__container">
              ...
              <button type="button" className="profile__edit-btn" onClick={handleEditProfileClick}/>
            </div>
            <p className="profile__job">Исследователь океана </p>
          </div>
          <button type="button" className="profile__add-btn" onClick={handleAddPlaceClick}/>
        </section>
